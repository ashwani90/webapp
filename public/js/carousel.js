...
var V,
  ...
  X = !1;
function ee(e) {
  var t = $(".home-banner-slider.swiper-slide-active .home-banner-progress-bar");
  clearInterval(V);
  var a = parseInt($(".banner-slide-duration").val());
  if (V = setInterval(function () {
    J >= 100 ? (J = 1, clearInterval(V), $(".swiper-button-next-1").click()) : (J++, t.css("width", J + "%"));
  }, 10 * a + 5), e) clearInterval(V), J = 0, t.css("width", "5%");else {}
}
function te() {
  clearInterval(V);
}
var ae = {
  bannerSwiper: "",
  imageZoomOut: function imageZoomOut() {
  ...
  init: function init() {
    var e = this;
    Q = parseInt($(".banner-slide-duration").val()), $(".gradient-halo").css("transition-duration", Q + "s"), Z = Q + 1, setTimeout(function () {
      e.bannerSwiper = new Swiper(".mySwiper", {
        ...
        on: {
          ...
          slideChange: function slideChange() {
            X = !0, ee(X), W = parseInt($(".banner-slide-duration").val()), ae.tickerAnimationReset(W), X = !1, ee(), setTimeout(function () {
              X = !0, ee(X), X = !1, ee();
            }, 400);
  ...
  tickerAnimationReset: function tickerAnimationReset(e) {
    e > 0 ? (Q = e, Z = Q) : (Z = Q, j = 0), cancelAnimationFrame(H);
    /*$(".home-banner .homer-banner-timer").css({
        opacity: 0
    }).removeClass("animate-start")*/
  },
  tickerAnimation: function tickerAnimation(e) {
    // if ((!j || e - j >= 1e3) && $(".home-banner-play-pause").hasClass("playing")) {
    j = e, Z--, G = !0, 95 == parseInt($(".home-banner-slider.swiper-slide-active .home-banner-progress-bar").css("width")) / parseInt($(".img-container").css("width")) * 100 ? (ae.bannerSwiper.slideNext(), setTimeout(function () {
      X = !0, ee(X), X = !1, ee();
    }, 400)) : $(".home-banner-counter").html(Z);
    // }
    H = window.requestAnimationFrame(ae.tickerAnimation);
  },
  timerCounter: function timerCounter() {
  ...
  handleDMImage: function handleDMImage() {
    setTimeout(function () {
      var e,
        t = {};
      $(".swiper-wrapper .swiper-slide .home-banner-box .non-svg-image").length && $(".swiper-wrapper .swiper-slide .home-banner-box").find("img").each(function () {
        e = $(this).attr("src"), "h" == e.charAt(0) && (t[$(this).attr("data-src")] = $(this).attr("src"));
...
$(document).ready(function () {
  ae.init(), ae.handleDMImage(), $(window).on("load", function () {
    setTimeout(function () {
      // ae.setDmControlID(),
      $(".home-banner-carousel .home-banner-slider.swiper-slide-active .img-container img").addClass("zoom-out"), $(".homeHeroCarousel .swiper-wrapper").removeAttr("aria-live");
    }, 500);
  }), $(".home-banner-button-prev").on("blur", function (e) {
    var t = $(this).parents(".homeHeroCarousel").find(".home-banner-button-next"),
      a = $(this).parents(".homeHeroCarousel").find(".swiper-wrapper"),
      n = $(this).parents(".homeHeroCarousel").find(".slide-updates");
    setTimeout(function () {
      $(document.activeElement)[0] == t[0] ? (console.log("inside"), a.attr("aria-live", "polite"), n.attr("aria-live", "polite")) : (a.removeAttr("aria-live"), n.removeAttr("aria-live"));
    }, 0);
  });
});
/******/ })()
