@extends('layout')
@section('custom_css')
<link rel="stylesheet" href="{{ mix('css/single-blog.css') }}" />
<link rel="stylesheet" type="text/css" href="{{ mix('css/font-icons.min.css') }}" >
@endsection
@section('section')
                    ...
                    <div class="col-12 col-lg-8 right-sidebar md-margin-60px-bottom sm-margin-40px-bottom">
                        <div class="row">
                            <div class="col-12 blog-details-text last-paragraph-no-margin margin-6-rem-bottom">
                                ...
                                <h5 class="alt-font font-weight-500 text-extra-dark-gray margin-4-half-rem-bottom">We believe people deserve to earn a living doing what they love - vimeo video post</h5>
                                <!-- start vimeo video -->
                ...
                <div class="row">
                    <div class="col-12 col-lg-9 mx-auto wow animate__fadeIn">
                        <ul class="blog-comment">
                            ...
                            <li>
                                <div class="author-info d-block d-md-flex w-100 align-items-center align-items-md-start ">
                                    <div class="w-75px sm-w-50px sm-margin-10px-bottom">
                                        <img src="https://via.placeholder.com/125x125" class="rounded-circle w-95 sm-w-100" alt=""/>
                                    </div>
                                    <div class="w-100 padding-25px-left last-paragraph-no-margin sm-no-padding-left">
