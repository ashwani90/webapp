@if ($paginator->hasPages())
    <nav role="navigation" style="margin-bottom: 20px" aria-label="{{ __('Pagination Navigation') }}" class="flex items-center justify-between">
